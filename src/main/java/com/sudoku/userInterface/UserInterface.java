...
public class UserInterface implements IUserInterfaceContract.View , EventHandler<KeyEvent> {
    ...
    private  static  final Color WINDOW_BACKGROUNG_COLOR =  Color.rgb(0,150,136);
    private  static  final Color BOARD_BACKGROUNG_COLOR =  Color.rgb(224,242,241);
    ...
    private void drawBackground(Group root) {
        ...
        scene.setFill(WINDOW_BACKGROUNG_COLOR);
    ...
    private void drawSudokuBoard(Group root) {
        ...
        boardBackground.setFill(BOARD_BACKGROUNG_COLOR);
